  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "alexisbenoistpro@gmail.com",
      href: "mailto:alexisbenoistpro@gmail.com",
      type: "link"
    },
    {
      icon: (
      ...
      label: "Téléphone",
      value: "À demander par mail ou via LinkedIn",
      type: "link"
    },
    {
      icon: (
    ...
    >
      ...
      >
        ...
        <p className="text-secondary leading-relaxed mb-8">
          ...
          collaboration ou d'une opportunité professionnelle. Je suis toujours
          ouvert aux nouvelles opportunités et échanges !
        </p>
      </motion.div>
