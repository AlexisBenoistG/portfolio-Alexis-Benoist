    ...
    <footer className="fixed bottom-0 w-screen">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center mb-4">
          <div className="relative rounded-2xl px-6 py-4 shadow-2xl shadow-slate-900/50 overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-sm opacity-80 text-footer">
                &copy; {new Date().getFullYear()} Portfolio Alexis Benoist —
